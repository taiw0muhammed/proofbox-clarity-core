...
export function ParticipantCard({ name, role, confirmed, time, initials, waitingLabel = "Waiting" }: { name: string; role: string; confirmed: boolean; time?: string; initials: string; waitingLabel?: string }) {
  return (
